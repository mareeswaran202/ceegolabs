                ...
                <div className="outer-box">
                  <div className="row m-0">
                    <div className="column col-lg-3 col-md-6">
                      <div className="image">
                        <img
                          src="/assets/images/resource/client-7.png"
                          alt=""
                        />
                      </div>
                    </div>
                    <div className="column col-lg-3 col-md-6">
                      <div className="image">
                        <img
                          src="/assets/images/resource/client-8.png"
                          alt=""
                        />
                      </div>
                    </div>
                    <div className="column col-lg-3 col-md-6">
                      <div className="image">
                        <img
                          src="/assets/images/resource/client-9.png"
                          alt=""
                        />
                      </div>
                    </div>
                    <div className="column col-lg-3 col-md-6">
                      <div className="image">
                        <img
                          src="/assets/images/resource/client-10.png"
                          alt=""
                        />
                      </div>
                    </div>
                    <div className="column col-lg-3 col-md-6">
                      <div className="image">
                        <img
                          src="/assets/images/resource/client-11.png"
                          alt=""
                        />
                      </div>
                    </div>
                    <div className="column col-lg-3 col-md-6">
                      <div className="image">
                        <img
                          src="/assets/images/resource/client-12.png"
                          alt=""
                        />
                      </div>
                    </div>
                    <div className="column col-lg-3 col-md-6">
                      <div className="image">
                        <img
                          src="/assets/images/resource/client-13.png"
                          alt=""
                        />
                      </div>
                    </div>
                    <div className="column col-lg-3 col-md-6">
                      <div className="image">
                        <img
                          src="/assets/images/resource/client-14.png"
                          alt=""
                        />
                      </div>
                    </div>
