                ...
                <div className="col-lg-8 content-side">
                  ...
                  <div className="row mb-5">
                    <div className="col-md-12">
                      <div className="text">
                        <p>
                          <span className="ceegotxtpara">Ceego Labs</span> is
                          equipped to efficiently handle medium and large
                          production runs, We can manufacture a variety of
                          delivery systems in multiple packaging formats so you
                          can offer your customers several options.{" "}
                        </p>
                      </div>
