...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={2} footerStyle={2} breadcrumbTitle="Distribution Support" wrapperCls="home_2">
                <div>
                                ...
                                <div className="col-lg-8 content-side">
                                    ...
                                    <div className="row mb-5">
                                        ...
                                        <div className="col-md-12">
                                            <div className="text"><p>As one of our service private label manufacturer, we have a strict focus on quality in our manufacturing operation. We only use state-of- the-art production technologies – and many of our progressive formulas are proven successful in many markets.All our products comply with, and exceed, the strictest regulatory standards</p></div>
